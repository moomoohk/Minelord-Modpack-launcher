...
import net.minelord.log.LogEntry;
import net.minelord.log.LogLevel;
...
import net.minelord.tools.TextureManager;
import net.minelord.tracking.AnalyticsConfigData;
import net.minelord.tracking.JGoogleAnalyticsTracker;
import net.minelord.tracking.JGoogleAnalyticsTracker.GoogleAnalyticsVersion;
				...
				catch (IllegalArgumentException e)
				{
					...
					else
					{
						if (responseStr.equalsIgnoreCase("bad login"))
						{
							...
							if (responseStr.equalsIgnoreCase("old version"))
							{
