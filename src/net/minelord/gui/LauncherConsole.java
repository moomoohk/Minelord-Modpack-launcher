...
import net.minelord.log.ILogListener;
import net.minelord.log.LogEntry;
import net.minelord.log.LogLevel;
import net.minelord.log.LogSource;
import net.minelord.log.LogType;
import net.minelord.log.LogWriter;
import net.minelord.log.Logger;
import net.minelord.tools.PastebinPoster;
...
public class LauncherConsole extends JFrame implements ILogListener
{
	...
	public LauncherConsole()
	{
		...
		ircButton.setToolTipText("Minelord Modpack support IRC channel");
