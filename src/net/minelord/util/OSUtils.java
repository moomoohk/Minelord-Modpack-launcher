...
public class OSUtils
{
	...
	public static String getDefInstallPath()
	{
		...
		return System.getProperty("user.dir") + "//Minelord Pack Install";
	}
	...
	public static String getDynamicStorageLocation()
	{
		...
		{
		case WINDOWS:
			return System.getenv("APPDATA") + "/minelordlauncher/";
		case MACOSX:
			return cachedUserHome + "/Library/Application Support/minelordlauncher/";
		case UNIX:
			return cachedUserHome + "/.minelordlauncher/";
		default:
	...
	public static void browse(String url)
	{
		try
		{
			if (Desktop.isDesktopSupported())
			{
				...
				if (getCurrentOS() == OS.UNIX)
				{
					// Work-around to support non-GNOME Linux desktop
					// environments with xdg-open installed
